...
<p>To use the OTP functionality to receive OTP through email, it is needed to be added with the email which has been 2-factor authenticated from the google and need get a password by google. Then add a temporary password given by google the views.py file and settings.py file. The OTP functinality will be executed.</p>
